...
```
https://github.com/yourusername/voice-agent-bridge.git
```
...
This package requires **NativeWebSocket** (`com.endel.nativewebsocket` v1.1.4), which will be installed automatically. If it fails, add it manually:
